...
export class DataNode extends LabelledNode {
    ...
    constructor(guard: any, location: Location, name: string, data: string, unpadded: boolean) {
    ...
    static from(options: any): DataNode {
        ...
        return new DataNode(Guard, options.loc, options.name, Object.freeze(options.data.map((d: any) => Node.from(d))), options.unpadded);
    }
}
