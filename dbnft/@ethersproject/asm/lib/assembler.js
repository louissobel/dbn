...
var DataNode = /** @class */ (function (_super) {
    ...
    function DataNode(guard, location, name, data, unpadded) {
        var _this = _super.call(this, guard, location, name, { data: data }) || this;
        _this.unpadded = unpadded;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.data[i].assemble(assembler, visit)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        if (!!this.unpadded) return [3 /*break*/, 6];
    ...
    DataNode.from = function (options) {
        ...
        return new DataNode(Guard, options.loc, options.name, Object.freeze(options.data.map(function (d) { return Node.from(d); })), options.unpadded);
    };
    return DataNode;
}(LabelledNode));
